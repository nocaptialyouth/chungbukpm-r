    ...
    return `
      <article class="institution-card" data-id="${escapeHtml(item.id)}">
        ...
        <div class="card-actions">
          ...
          <a href="${escapeHtml(homepage || homepageSearchUrl(item))}" target="_blank" rel="noopener">${homepage ? "홈페이지" : "네이버 검색"}</a>
    ...
    elements.dialogContent.innerHTML = `
      ...
      <div class="dialog-body">
        <div class="dialog-actions">
          ...
          <a href="${escapeHtml(homepage || homepageSearchUrl(item))}" target="_blank" rel="noopener">${homepage ? "공식 홈페이지 ↗" : "네이버 검색 ↗"}</a>
